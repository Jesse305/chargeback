...
<div class="container">
	...
	<div class="row">
		<div class="col-xs-12 col-md-8 col-md-offset-2">
			<form id="form_orgao" method="POST" action={{route('orgao.atualizar', $orgao->id)}}>
				{{csrf_field()}}		
				  <div class="input-group">
				    <span class="input-group-addon">Nome:</span>
				    <input id="no_orgao" type="text" class="form-control" name="no_orgao" placeholder="Nome do Orgão"
				    required maxlength="100" value="{{$orgao->no_orgao}}" >
				  </div>
				  ...
				  <div class="input-group">	
			    	...
			    	required maxlength="15" onkeyup="maiuscula(this);" value="{{$orgao->no_sigla}}">			    
				  </div>
