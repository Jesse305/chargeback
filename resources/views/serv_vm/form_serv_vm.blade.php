			...
			<select class="form-control" name="unidade_id" id="unidade_id">
				@if(isset($serv_vm))
					@if(count($serv_vm->unidade) > 0)
						<option value="{{$serv_vm->unidade->id}}">{{$serv_vm->unidade->no_unidade}}</option>
					@else
	...
	<div class="col-xs-12 col-md-6">
		<div class="input-group">
			...
			<select class="form-control" name="responsavel_id" id="responsavel_id">
				@if(isset($serv_vm))
					@if(count($serv_vm->responsavel))
						<option value="{{$serv_vm->responsavel->id}}">{{$serv_vm->responsavel->no_responsavel}}</option>
					@else
